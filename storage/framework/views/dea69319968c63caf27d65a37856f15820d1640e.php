...
<head>
    ...
    <title>Recibo - Reviva Fotografia</title>
    <style type="text/css">
        ol {
            margin: 0;
            padding: 0
...
<body class="c7">
    ...
    <p class="c2"><span class="c0"></span></p>
    <p class="c2"><span class="c0"></span></p>
    <p class="c8"><span class="c0">Recebemos a importância de R$ <?php echo e($request['tValor']); ?> do Sr (a): <?php echo e($request['tPessoa']); ?>, Ref.: <?php echo e($request['tDescricao']); ?>.</span></p>
    <p class="c1"><span class="c0"></span></p>
    <p class="c1"><span class="c0"></span></p>
    <p class="c5"><span class="c6">Castanhal, <?php echo e($dataExtenso); ?></span></p>
    <p class="c4"><span class="c6"></span></p>
    <p class="c4"><span class="c6"></span></p>
    <p class="c3"><span class="c6">________________________________________________________________________</span></p>
    <p class="c3"><span class="c6">Castanhal - Pa</span></p>
</body>
